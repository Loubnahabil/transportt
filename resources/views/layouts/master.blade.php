            ...
            <ul class="nav user-menu">
                <li class="nav-item dropdown noti-dropdown">
                    <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                        ...
                        <span class="badge badge-pill">{{ count($expiredVehicules) + count($arrivedVoyages) }}</span>
                    </a>
                    <div class="dropdown-menu notifications">
                        ...
                        <div class="noti-content">
                            <ul class="notification-list">
                                @foreach ($expiredVehicules as $vehicule)
                                    <li class="notification-message">
                                        <a href="#">
                                            <div class="media">
                                                <div class="media-body">
                                                    <p class="noti-details">
                                                        Le véhicule {{ $vehicule->matricule }} a dépassé sa date de validité !
                                                    </p>
                                                    <p class="noti-time">
                                                        <span class="notification-time">
                                                            {{ \Carbon\Carbon::createFromFormat('d/m/Y', $vehicule->validite_date)->startOfDay()->diffForHumans(null, true) }}
                                                        </span>                                                    </p>
                                ...
                                @endforeach
                                @foreach ($arrivedVoyages as $voyage)
    <li class="notification-message">
        <a href="#">
            <div class="media">
                <div class="media-body">
                    <p class="noti-details">
                        Le voyage {{ $voyage->id }} est arrivé à destination.
                    </p>
                    <p class="noti-time">
                        <span class="notification-time">
                            {{ \Carbon\Carbon::createFromFormat('d/m/Y', $voyage->date_arrivee)->startOfDay()->diffForHumans(null, true) }}
                        </span>
                    </p>
...
@endforeach
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="vehicule-submenu">
                            <a href="{{ route('form/allvehicules/page') }}"><i class="fas fa-car"></i> <span>
                                    Vehicules </span></a>
                        </li>
                        <li class="chauffeur-submenu">
                            <a href="{{ route('form/allchauffeurs/page') }}"><i class="fas fa-user-tie"></i> <span>
                                    Chauffeurs </span></a>
                        </li>
                        ...
                        <li class="marchandise-submenu">
                            <a href="{{ route('form/allmarchandises/page') }}"><i class="fas fa-cube"></i> <span>
                                    Marchandises </span></a>
                        </li>
                        <li class="voyage-submenu">
                            <a href="{{ route('form/allvoyages/page') }}"><i class="fas fa-truck"></i> <span> Voyages
                                </span></a>
                        </li>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var elements = document.querySelectorAll('#vehicules_select');
