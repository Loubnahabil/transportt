        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <div class="mt-5">
                            <h4 class="card-title float-left mt-2">Clients</h4> <a href="{{ route('form/addclient/page') }}" class="btn btn-primary float-right veiwbutton">Ajouter Client</a> </div>
                        </div>
                    </div>
                </div>
                <div class="row">
